...
import "@pancakewap/pancake-swap-lib/contracts/token/BEP20/BEP20.sol";

// FruitToken with Governance.
contract FruitToken is BEP20('FruitDex Token', 'Fruit') {
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying Fruits (not scaled);
